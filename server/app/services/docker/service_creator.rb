...
module Docker
  class ServiceCreator
    ...
    def create_service_instance(instance_number, deploy_rev)
      service_spec = self.service_spec(instance_number, deploy_rev)
    ...
    # @param [String] deploy_rev
    # @return [Hash]
    def service_spec(instance_number, deploy_rev)
      spec = {
